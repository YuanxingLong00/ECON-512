...
% For M=2
% When N=100, R=1000, B=500, the rejection probability from this bootstrap
% method is 0.0770 for DGP1.

% When N=200, R=1000, B=500, the rejection probability from this bootstrap
% method is 0.0650 for DGP1.

% When N=500, R=1000, B=500, the rejection probability from this bootstrap
% method is  for DGP1.

% When N=500, R=1000, B=1000, the rejection probability from this bootstrap
% method is 0.0570 for DGP1.


% When N=500, R=500, B=500, the rejection probability from this bootstrap method
% is 0.0580 for DGP1.
    
% When N=1000, R=500, B=500, the rejection probability from this bootstrap method
% is 0.0540 for DGP1.

% For M=0
% When N=100, R=1000, B=500, the rejection probability from this bootstrap
% method is 0.077 for DGP1.
